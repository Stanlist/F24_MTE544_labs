...
class planner:
    ...
    def initTrajectoryPlanner(self):
        ...
        # PROBABILY WANT TO TUNE THIS STANDARD DEVIATION
        self.m_utilites=mapManipulator(laser_sig=.5) 
    ...
    def trajectory_planner(self, startPoseCart, endPoseCart):
        ...
        # Get the path from the A* search
        aStarPath = search(self.costMap, startPose, endPose)
        
        # TODO PART 5 convert the cell pixels into the cartesian coordinates
        
        Path = list(map(self.m_utilites.cell_2_position, aStarPath))
